...
/*
	The personIDHandler is the HTTP handler that processes
	...
	personIDHandler.handle() which actually processes the request.
*/
        ...
        try {
            ...
            if (exchange.getRequestMethod().toLowerCase().equals("get")) {
                ...
                if (reqHeaders.containsKey("Authorization")) {
                    ...
                    String person_id = URI.split("/")[2];

                    //call the person service
                    PersonIDService service = new PersonIDService();
                    PersonIDResult result = service.personID(authToken, person_id);
