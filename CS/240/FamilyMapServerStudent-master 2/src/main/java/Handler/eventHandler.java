...
/*
	The eventHandler is the HTTP handler that processes
	incoming HTTP requests that contain the "/event" URL path.

	Notice that eventHandler implements the HttpHandler interface,
	...
	eventHandler.handle() which actually processes the request.
*/
        ...
        try {
            ...
            if (exchange.getRequestMethod().toLowerCase().equals("get")) {
                ...
                if (reqHeaders.containsKey("Authorization")) {
                    ...
                    EventResult result = service.event(authToken);
